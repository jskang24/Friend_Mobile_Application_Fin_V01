...
import 'package:friend_mobile/ui/google_signup/hobbies_select_screen.dart';
...
class GoogleProfilePicSelectScreen extends StatefulWidget {
  String name = "";
  String surname = "";
  String user = "";
  String password = "";
  ...
  @override
  State<StatefulWidget> createState() => _GoogleProfilePicSelectScreenState();
}

class _GoogleProfilePicSelectScreenState
    extends State<GoogleProfilePicSelectScreen> {
                    ...
                    CupertinoButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => GoogleHobbiesSelectScreen(
                                name: widget.name,
