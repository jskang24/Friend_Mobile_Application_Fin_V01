...
class GoogleHobbiesSelectScreen extends StatefulWidget {
  String name = "";
  String surname = "";
  String email = "";
  String password = "";
  ...
  @override
  _GoogleHobbiesSelectScreenState createState() {
    return _GoogleHobbiesSelectScreenState();
  }
}

class _GoogleHobbiesSelectScreenState extends State<GoogleHobbiesSelectScreen> {
    ...
    try {
      ...
      for (var a in hobbiesList) {
        ...
        if (users.contains(user) == false) {
          addHobbies.update({
            'userlist': FieldValue.arrayUnion([user]),
          });
        }
      }
      print("Created");
...
//       onTap: () {
//         setState(() {
//           _GoogleHobbiesSelectScreenState._addHobby();
//         });
