...
//   }
  ...
  retrieveName(String uid) async {
    await FirebaseFirestore.instance
      ...
      // print(documentSnapshot);
      setState(() {
        pfp = documentSnapshot['photo'];
        name = documentSnapshot['name'] + " " + documentSnapshot['surname'];
      });
    });
  }
  ...
  retrieve() async {
    ...
    for (var i = 0; i < comm.length; i++) {
      await FirebaseFirestore.instance
          ...
          .then((DocumentSnapshot documentSnapshot) {
        setState(() {
          postName.add(documentSnapshot['postName']);
          like.add(documentSnapshot['like']);
          caption.add(documentSnapshot['caption']);
        });
      });
    }
    print(posts);
                ...
                SizedBox(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          retrieveName(auth.currentUser!.uid);
                          try {
